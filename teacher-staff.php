<?php
  ...
  include('include/inner-header.php')

?>

<?php
 
  include('include/inner-flash-news.php')
    ...
    <section class="welcome-area about"
        ...
        <div class="row">
            <div class="col-lg-12 col-sm-12 about-col">
                <h3 class="main-heading2 text-uppercase">Staff Teacher</h3>

                <div class="row">
                    <div class="col-sm-6 col-12">
                        <ul class="list-unstyled list-style-3">
                            <li><a href="uploads/documents/LIST-GUEST-TEACHERS-ANGLO-ARABIC.docx" target="_blank">LIST
                                    OF
                                    GUEST
                                    TEACHERS
                                    ANGLO ARABIC</a></li>
                ...
                <br>
                <br>
                <h3 class="main-heading2 text-uppercase">Staff Members</h3>

                <div class="row">
                    <div class="col-sm-6 col-12">
                        <ul class="list-unstyled list-style-3">
                            <li><a href="uploads/documents/STAFF-MEMBERS-LIST.xls" target="_blank">STAFF MEMBERS
                                    LIST</a></li>
                        </ul>
                    </div>
